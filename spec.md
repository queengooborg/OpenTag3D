...
| Color Hex             | RGB     | Int[1+1+1+1]   | 0xC4          | 4            | Display-only | `[255, 166, 77, 255]`             | Color stored as 3 separate 1-byte integers for red, green and blue, in the sRGB color space.                                                    |
| Target Diameter       | µm      | Int            | 0x4E          | 2            | Operational  | `1750`, `2850`                    | Filament diameter (target) in µm (micrometers). Eg `1750` → `1.750mm`.                                                                          |
| Target Weight         | g       | Int            | 0x50          | 2            | Operational  | `1000`, `5000`, `750`             | Filament weight in grams, excluding spool weight. This is the TARGET weight (e.g., 1kg). Actual measured weight is stored in a different field. |
| Print Temperature     | °C ÷5   | Int            | 0x52          | 1            | Operational  | `42`                              | Recommended print temperature in degrees Celsius, divided by 5. For example, `42` = `210°C`.                                                    |
| Bed Temperature       | °C ÷5   | Int            | 0x53          | 1            | Operational  | `12`, `16`                        | Recommended bed temperature in degrees Celsius, divided by 5. For example, `12` = `60°C`.                                                       |
| Density               | µg      | Int            | 0x56          | 2            | Operational  | `1240`, `3900`                    | Filament density in µg (micrograms) per cubic centimeter. Eg `1240` → `1.240g/cm³`.                                                             |
